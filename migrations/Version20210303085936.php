 ...
 */
final class Version20210303085936 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE produit ADD fournisseur_id INT NOT NULL, ADD editeur_id INT DEFAULT NULL, CHANGE auteur_id genre_id INT NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE produit ADD auteur_id INT NOT NULL, DROP genre_id, DROP fournisseur_id, DROP editeur_id');
